    ...
    <div class="w-full sm:mx-4">
        <div class="flex flex-col">
            <div class="mt-4">
                ...
                <form class="grid grid-cols-1 gap-4 sm:grid-cols-2" action="{{ route('dashboard.unit.update', $unit->id) }}"
                    method="POST" class="">
                    <div
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-1">
                                    ...
                                    <label class="form-control col-span-full" for="description">
                                        ...
                                        <textarea name="description" id="description" class="textarea textarea-bordered textarea-secondary"
                                            placeholder="Deskripsi Produk"> {{ old('description', $unit->description) }}</textarea>

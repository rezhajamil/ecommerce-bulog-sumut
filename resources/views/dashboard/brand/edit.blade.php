...
@section('body')
    <div class="w-full sm:mx-4">
        <div class="flex flex-col">
            <div class="mt-4">
                <a href="{{ route('dashboard.brand.index') }}" class="btn btn-outline mb-4 mt-2">
                    <i class="fa-solid fa-arrow-left mr-2"></i>
                    Kembali
                </a>
                <h4 class="align-baseline text-xl font-bold text-primary">
                    Edit Data Merk Produk
                </h4>

                <form class="grid grid-cols-1 gap-4 sm:grid-cols-2" action="{{ route('dashboard.brand.update', $brand->id) }}"
                    method="POST" class="">
                    <div
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6">
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-1">
                                    <label class="form-control w-full" for="name">
                                        <div class="label">
                                            <span class="label-text">Nama Merk Produk*</span>
                                        </div>
                                        <input type="text" placeholder="Nama Merk Produk" name="name" id="name"
                                    ...
                                    <label class="form-control col-span-full" for="description">
                                        ...
                                        <textarea name="description" id="description" class="textarea textarea-bordered textarea-secondary"
                                            placeholder="Deskripsi Produk"> {{ old('description', $brand->description) }}</textarea>

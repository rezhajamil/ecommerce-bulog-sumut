...
@section('body')
    <div class="container w-full">
        <div class="flex flex-col">
            <div class="mt-4">
                <h4 class="align-baseline text-xl font-bold text-primary">Daftar Merk Produk</h4>
                ...
                <div class="flex justify-between">
                    ...
                    <a href="{{ route('dashboard.brand.create') }}" class="btn btn-primary mb-4 mt-2 text-base-100">
                        <i class="fa-solid fa-plus mr-2"></i>
                        Data Merk Produk Baru
                    </a>
                </div>
                        ...
                        <tbody>
                            @forelse ($brands as $key => $brand)
                                <tr class="hover:bg-gray-200">
                                    ...
                                    <td class="nama p-3 text-gray-700">{{ $brand->name }}</td>
                                    <td class="deskripsi p-3 text-gray-700">{!! $brand->description !!}</td>
                                    ...
                                    <td class="p-3 text-gray-700">
                                        <a href="{{ route('dashboard.brand.edit', $brand->id) }}"
                                            class="my-1 block text-base font-semibold text-accent transition hover:text-primary">Edit</a>
                                        <form action="{{ route('dashboard.brand.toggle_status', $brand->id) }}"
                                            method="get">
                                            @csrf
                                            <button
                            ...
                            @empty
                                <tr>
                                    <td colspan="100">
                                        <p class="p-2 text-center italic">Tidak ada data Merk Produk</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

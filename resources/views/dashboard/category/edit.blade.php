...
@section('body')
    <div class="w-full sm:mx-4">
        <div class="flex flex-col">
            <div class="mt-4">
                <a href="{{ route('dashboard.category.index') }}" class="btn btn-outline mb-4 mt-2">
                ...
                <form class="grid grid-cols-1 gap-4 sm:grid-cols-2"
                    action="{{ route('dashboard.category.update', $category->id) }}" method="POST" class="">
                    <div
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-6">
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-1">
                                    <label class="form-control w-full" for="name">
                                        <div class="label">
                                            <span class="label-text">Nama Kategori Produk*</span>
                                        </div>
                                        <input type="text" placeholder="Nama Kategori Produk" name="name"
                                    ...
                                    <label class="form-control col-span-full" for="description">
                                        ...
                                        <textarea name="description" id="description" class="textarea textarea-bordered textarea-secondary"
                                            placeholder="Deskripsi Produk"> {{ old('description', $category->description) }}</textarea>

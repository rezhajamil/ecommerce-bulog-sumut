        ...
        <div class="flex flex-col">
            <div class="mt-4">
                ...
                <form class="grid grid-cols-1 gap-4 sm:grid-cols-2"
                    action="{{ route('dashboard.warehouse.update', $warehouse->id) }}" method="POST" class=""
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    ...
                                    <label class="form-control w-full">
                                        ...
                                        <input id="image" type="file" name="image"
                                            ...
                                            value="{{ old('image', $warehouse->image) }}" />
                                    ...
                                    <label class="form-control col-span-full" for="description">
                                        ...
                                        <textarea name="description" id="description" class="textarea textarea-bordered textarea-secondary"
                                            placeholder="Deskripsi Produk"> {{ old('description', $warehouse->description) }}</textarea>
                    ...
                    <div
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-1" id="image-grid">
                            @if ($warehouse->image)
                                <label class="relative h-full overflow-hidden rounded border-2">
